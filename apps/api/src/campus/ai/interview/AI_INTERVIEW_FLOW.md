...
**Web (Next.js)**
- UI page: `apps/web/app/(app)/campus/ai/page.tsx`
- UI client component: `apps/web/app/(app)/campus/ai/_live-interview.tsx`
- Next.js API proxy routes:
  - Start: `apps/web/app/api/campus/ai-interview/sessions/route.ts`
  - Answer: `apps/web/app/api/campus/ai-interview/sessions/[sessionId]/answer/route.ts`
  - End: `apps/web/app/api/campus/ai-interview/sessions/[sessionId]/end/route.ts`
  - Get session: `apps/web/app/api/campus/ai-interview/sessions/[sessionId]/route.ts`

**API (NestJS)**
- Controller: `apps/api/src/campus/ai/interview/ai-interview.controller.ts`
- Module wiring: `apps/api/src/campus/ai/interview/ai-interview.module.ts`

**Orchestrator + agents**
- Orchestrator: `apps/api/src/campus/ai/interview/agents/coordinator.agent.ts`
- Question generator: `apps/api/src/campus/ai/interview/agents/interviewer.agent.ts`
- Depth probe (follow-ups): `apps/api/src/campus/ai/interview/agents/depth-probe.agent.ts`
- Classifier (intent/quality/cheating signals): `apps/api/src/campus/ai/interview/agents/classifier.agent.ts`
- Evaluator (final report): `apps/api/src/campus/ai/interview/agents/evaluator.agent.ts`

**LLM + utilities**
- LLM client wrapper: `apps/api/src/campus/ai/interview/openrouter.client.ts`
- JSON extraction helper: `apps/api/src/campus/ai/interview/llm-json.ts`

**“Tools” / context enrichment**
- Context builder (DB + resume/JD summarization): `apps/api/src/campus/ai/interview/tools/interview-tools.service.ts`

**Persistence**
- Prisma models: `apps/api/prisma/schema.prisma` (`AiInterviewSession`, `AiInterviewTurn`, `AiInterviewEvaluation`)
